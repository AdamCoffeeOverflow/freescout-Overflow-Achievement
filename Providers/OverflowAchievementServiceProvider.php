...
class OverflowAchievementServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Avoid Laravel's mergeConfigFrom() here.
        // In the FreeScout/Laravel version used by many installs, mergeConfigFrom()
        // can fatally error when an existing nested value is scalar instead of array,
        // and it also reindexes numeric keys (bad for the manual level curve).
    ...
    /**
     * Safer config merge for FreeScout's Laravel baseline.
     *
     * Why not mergeConfigFrom()?
     * - some installs can end up with stale scalar values at nested config keys,
     *   which makes array_merge() fatal during provider registration;
     * - numeric keys must be preserved for the manual level curve.
     */
    ...
    protected function registerAssets(): void
    {
        ...
        \Eventy::addFilter('javascripts', function ($javascripts) {
            ...
            // Keep the shipped bootstrap file optional and minimal.
            // Per-user URLs, locale strings, and runtime settings are loaded via
            // the module bootstrap endpoint inside module.js, which avoids
            // mirroring settings into a generated static asset.
